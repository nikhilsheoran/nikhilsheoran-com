...
import { IconHome, IconHeart, IconPerson, IconDisc, IconMusic, IconPrev, IconPlay, IconPause, IconNext, IconVolumeLow, IconVolumeHigh, IconChevronLeft, IconPlayFill, IconEqualizer } from "@/app/_components/music/music-icons";
